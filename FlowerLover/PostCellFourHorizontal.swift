...
class PostCellFourHorizontal: BasePostCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        imageView2.snp.makeConstraints { (make) in
            make.top.equalTo(imageView1.snp.bottom).offset(Styles.Constant.spacing)
            make.leading.bottom.equalToSuperview()
            make.height.equalTo(imageView1).multipliedBy(0.67)
        }
        
        imageView3.snp.makeConstraints { (make) in
            make.top.equalTo(imageView2)
            make.leading.equalTo(imageView2.snp.trailing).offset(Styles.Constant.spacing)
            make.bottom.equalToSuperview()
            make.width.equalTo(imageView2)
        }
        
        imageView4.snp.makeConstraints { (make) in
            make.top.equalTo(imageView3)
            make.leading.equalTo(imageView3.snp.trailing).offset(Styles.Constant.spacing)
            make.trailing.bottom.equalToSuperview()
            make.width.equalTo(imageView3)
        }
